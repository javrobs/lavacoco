...
const RegisterPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch("/api/add_password_admin_invite/",{
            method:"POST",
    ...
    return <MainContainer size="sm">
        <form className="bubble-div flex flex-col gap-2" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-1 mb-2 flex-wrap">
                <h1 className="text-orange-700">Hola, {user_info.first_name}!</h1>
            ...
            <p>Inicia sesión con esta contraseña y tu número de teléfono para acceder a tus órdenes y a nuestro programa de cliente frecuente.</p>
            <ErrorMessage errorContent={errorMessage}/>
            <div className="grid sm:grid-cols-2 gap-2">
                <PasswordInputs signupState={signupState} handleChange={handleChange}/>
            </div>
            <button className="btn-go btn self-center mt-4">Registrarme<Icon icon="arrow_forward"/></button>
